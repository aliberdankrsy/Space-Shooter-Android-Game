package com.aliberdankrsy.coolspaceshooter;
...
public class OurSpaceship {
    ...
    private void resetOurSpaceship() {
        ox = random.nextInt(CoolSpaceShooter.screenWidth);
        oy = CoolSpaceShooter.screenHeight - ourSpaceship.getHeight();
        ourVelocity = 10 + random.nextInt();
    }
}
